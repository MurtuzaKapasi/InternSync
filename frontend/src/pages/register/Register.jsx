...
const Register = ()=> {
    return (
        <div className="bg-[#fbfbfb] min-h-screen flex flex-col lg:flex-row justify-center items-center">
          <div className="lg:w-1/2 flex flex-col justify-center items-center border-r lg:border-10 border-gray-300 pr-4 lg:pr-0">
            ...
            />
            <h1 className="text-lg font-semibold mb-2">Register as Job Seeker</h1><br/>
            ...
            <button className="bg-gray-800 text-white px-6 py-3 rounded-lg font-semibold shadow-md hover:bg-gray-900 transition duration-300">Register</button>
          </div>
          <div className="lg:w-1/2 flex flex-col justify-center items-center pl-4 lg:pl-0">
            <img
              ...
              className="w-80 h-80 mb-4"
            />
            <h1 className="text-lg font-semibold mb-2">Register as Recruiter</h1><br/>
